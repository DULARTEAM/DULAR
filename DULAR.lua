...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./DULAR.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("KU", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S DULAR -X kill
screen -S DULAR ./DULAR
done
]])  
file:close() 
...
sudo_users = {SUDO,1714667945,17146679454}   
...
if hash or SudoBot(msg) or DevDULARW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevDULARW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevDULARW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevDULARW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevDULARW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevDULARW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevDULARW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1714667945) then  
var = true  
elseif tonumber(user_id) == tonumber(17146679454) then
var = true  
...
if tonumber(user_id) == tonumber(1714667945) then  
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1714667945) then
...
local UserName = (data.username_ or "FU55U")
...
local DULAR_Msg = ''  
if msgs < 100 then 
DULAR_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
DULAR_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
DULAR_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
DULAR_Msg = 'متفاعل' 
elseif msgs < 1200 then 
DULAR_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
DULAR_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
DULAR_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
DULAR_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
DULAR_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
DULAR_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
DULAR_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
DULAR_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
DULAR_Msg = 'رب التفاعل'  
end 
return DULAR_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@QGQGA")  
...
--------------------------------------------------------------------------------------------------------------
function SourceDULAR(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
SourceDULARr = '*⌯︙اهلا عزيزي*\n*⌯︙انا بوت اسمي '..Namebot..'*\n*⌯︙اختصاصي حمايه الكروبات*\n*⌯︙من تكرار والسبام والتوجيه والخ…*\n*⌯︙لتفعيلي اتبع الاخطوات…↓*\n*⌯︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n⌯︙[قناة سورس البوت](http://t.me/FU55U)'
end
send(msg.chat_id_, msg.id_, SourceDULARr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevDULARW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevDULARW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,DULAR_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ⌯' and DevDULARW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevDULARW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevDULARW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevDULARW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevDULARW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevDULARW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevDULARW(msg) then 
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/FU55U) \n⌯︙[قناه السورس](t.me/FU55U)')
end
if text == "ضع اسم للبوت ⌯" and DevDULARW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevDULARW(msg) then 
...
if text == 'المشتركين ⌯' and DevDULARW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevDULARW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevDULARW(msg) then
...
if text == ("قائمه العام ⌯") and DevDULARW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevDULARW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevDULARW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevDULARW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevDULARW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevDULARW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevDULARW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevDULARW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevDULARW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⌯" and DevDULARW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان » { '..#group..' }'..DULARk..''..DULAR..'*\n*⌯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevDULARW(msg) then
...
usertext = '*\n ⌯︙العضو »* ['..result.title_..'](t.me/'..(username or 'FU55U')..')'
status  = '\n *⌯︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevDULARW(msg) then
...
usertext = '\n *⌯︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'FU55U')..')'
status  = '\n*⌯︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevDULARW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevDULARW(msg) then
...
local DULAR1_Msg = database:get(bot_id.."DULAR1:Add:Filter:Rp2"..text..msg.chat_id_)   
if DULAR1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'FU55U')..') \n ⌯︙'..DULAR1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if DULAR_Msg and not Special(msg) then  
local DULAR_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if DULAR_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..DULAR_Msg.."] \n")
else
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/FU55U)}\n⌯︙["..DULAR_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " *⌯︙عذرا »* {["..data.first_name_.."](T.ME/FU55U)}\n*⌯︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevDULARW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevDULARW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevDULARW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevDULARW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevDULARW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevDULARW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevDULARW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevDULARW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevDULARW(msg) then  
...
database:sadd(bot_id.."DULAR:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."DULAR:blocname"..msg.chat_id_)
...
function QGQGA_name(t1,t2)
if t2.id_ then 
name_DULAR = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_DULAR then 
names_DULAR = database:smembers(bot_id.."DULAR:blocname"..msg.chat_id_) or ""
if names_DULAR and names_DULAR[1] then 
for i=1,#names_DULAR do 
if name_DULAR:match("(.*)("..names_DULAR[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, QGQGA_name)
end
...
database:set(bot_id.."DULAR:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."DULAR:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."DULAR:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."DULAR:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."DULAR:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_DULARa_new(DULAR1,DULAR2)
if DULAR2 and DULAR2.first_name_ then 
if DULAR2.first_name_:match("(.*)"..database:get(bot_id.."DULAR:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."DULAR:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local DULAR_nnn = database:get(bot_id.."DULAR:nump"..msg.chat_id_) or 5
local DULAR_nnn2 = database:get(bot_id.."DULAR:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(DULAR_nnn2) == tonumber(DULAR_nnn) or tonumber(DULAR_nnn2) > tonumber(DULAR_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."DULAR:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..DULAR2.username_.."](https://t.me/"..(DULAR2.username_ or "FU55U")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DULAR:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(DULAR_nnn) - tonumber(DULAR_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_DULARa_new)
end
end
...
local DULARChengName = database:get(bot_id.."DULAR:Cheng:Name"..data.id_)
if not data.first_name_ then 
if DULARChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..DULARChengName..']')
database:del(bot_id.."DULAR:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if DULARChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."DULAR:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local DULARChengUserName = database:get(bot_id.."DULAR:Cheng:UserName"..data.id_)
if not data.username_ then 
if DULARChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..DULARChengUserName..']')
database:del(bot_id.."DULAR:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if DULARChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."DULAR:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local DULARChengPhoto = database:get(bot_id.."DULAR:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if DULARChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."DULAR:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if DULARChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."DULAR:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
*أهلاً بك في السوࢪس* [DULAR TEAM💘](t.me/FU55U)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناه السوࢪس 💘',url="https://t.me/FU55U"},
},
{
{text = 'لتنصيب السوࢪس 💘',url="https://t.me/FU55U/3"},
},
{
{text = 'تواصل السوࢪس 💘',url="t.me/QGQGABOT"},
},
{
{text = 'مطوࢪ السوࢪس 💘',url="t.me/QGQGA"},
},
}
...
if text == 'رفع نسخه الاحتياطيه' and DevDULARW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'FU55U')..') \n*⌯︙تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'FU55U')..') \n*⌯︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevDULARW(msg) then    
dofile('DULAR.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevDULARW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevDULARW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevDULARW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevDULARW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevDULARW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevDULARW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevDULARW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevDULARW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevDULARW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevDULARW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevDULARW(msg) then
...
if database:get(bot_id.."QGQGA:admin:Time"..msg.chat_id_) then 
return
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'QGQGA:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevDULARW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevDULARW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "FU55U")
...
function Function_DULAR(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DULAR, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_DULAR, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'FU55U')..')'
status  = '\n*⌯︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌯︙العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'FU55U')..')'
...
database:set(bot_id.."DULAR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."DULAR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌯︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."DULAR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."DULAR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."DULAR1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."DULAR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌯︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."DULAR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."DULAR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."DULAR1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."DULAR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌯︙ارسل الكلمه الان*")  
database:set(bot_id.."DULAR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."DULAR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."DULAR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DULAR1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."DULAR1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."DULAR1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."DULAR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DULAR1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."DULAR1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n *⌯︙قائمة المنع* \n*•━━━━━━ KY ━━━━━━━•*\n"
for k,v in pairs(list) do  
local DULAR_Msg = database:get(bot_id.."DULAR1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..DULAR_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevDULARW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevDULARW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌯︙العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'FU55U')..')'..'\n*⌯︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevDULARW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevDULARW(msg) then  
...
if not database:get(bot_id..'QGQGA:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'QGQGA:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
send(msg.chat_id_, msg.id_,'['..DULAR_Msg[math.random(#DULAR_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevDULARW(msg) then 
...
if text == ("مسح ردود المطور") and DevDULARW(msg) then 
...
if text == ("ردود المطور") and DevDULARW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n *⌯︙قائمة ردود المطور* \n*•━━━━━━ KY ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevDULARW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevDULARW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevDULARW(msg) then   
...
if text == 'تعطيل المغادره' and DevDULARW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌯︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DULAR')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'FU55U')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
DULARdx(msg.chat_id_, msg.id_, ' *⌯︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌯︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌯︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌯︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevDULARW(msg) then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'DULAR TEAM.',url="t.me/FU55U"}},
}
local msg_id = msg.id_/2097152/0.5
...
DULAR = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(DULAR)
...
--------------------------------------------------------------------------------------------------------------
SourceDULAR(data.message_,data)
...
------------------------------------------------------------------------
local DULARAbot = database:get(bot_id.."DULAR1:Add:Filter:Rp2"..text..result.chat_id_)   
if DULARAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..DULARAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local DULAR1_Msg = database:get(bot_id.."DULAR1:Add:Filter:Rp2"..text..result.chat_id_)   
if DULAR1_Msg then    
send(msg.chat_id_, msg.id_," ⌯︙"..DULAR1_Msg)
